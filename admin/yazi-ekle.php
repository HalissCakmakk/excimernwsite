	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="col-lg-12">
			...
			if(isset($_POST['yazi-ekle'])){
				$tabloya_ekle = $db->prepare("INSERT INTO yazilar SET yazar=?,baslik=?,resim=?,yazi=?,tarih=?,kategori=?");
				$insert=$tabloya_ekle->execute(array($yazar,$baslik,$resim,$yazi,$tarih,$kategori));
				...
				if ($insert) {
					...
					echo '<div class="alert bg-warning" role="alert"><svg class="glyph stroked checkmark"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#stroked-checkmark"></use></svg> Duyuru yazısı eklenemedi! <a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a></div>';
					echo '<meta http-equiv="refresh" content="3;URL=yazilar.php">';
				}
			}
